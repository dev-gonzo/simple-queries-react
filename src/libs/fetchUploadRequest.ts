...
export const fetchUploadRequest = async ({
  url = "",
  endpoint,
  errorFn,
  pathRest,
...
> = {}) => {
  ...
  try {
    ...
    formData.append(uploadFileName, file!); // Note que adicionamos o '!' para assegurar ao TypeScript que file não é null ou undefined
